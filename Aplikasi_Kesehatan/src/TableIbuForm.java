 ...
 * @author ASUS
 */
public class TableIbuForm extends javax.swing.JInternalFrame {
    
    
    /**
     * Creates new form TableIbuForm
     */
    ...
    private void initComponents() {
        ...
        TabelDataIbu_tab = new javax.swing.JTable();
        ...
        TabelDataIbu_tab.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        TabelDataIbu_tab.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Nama Anak", "NIK", "Umur Ibu", "Tanggal Lahir", "Umur Kehamilan", "Alamat", "status", "ANC", "Riwayat Kesehatan"
            }
        ));
        TabelDataIbu_tab.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane1.setViewportView(TabelDataIbu_tab);
    ...
    private void cari_btActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cari_btActionPerformed
        if(cari_txt.getText().isEmpty()){
            ...
            String query = "SELECT * FROM ibu WHERE nama LIKE '%" + searchText + "%' OR nik LIKE '%" + searchText + "%'";
            showTable(query);
        }
    ...
    private void Update_btActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update_btActionPerformed
        int selectedRow = TabelDataIbu_tab.getSelectedRow();
        if (selectedRow == -1) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                selectedNik = TabelDataIbu_tab.getValueAt(selectedRow, 1).toString();
    ...
    private void delete_btActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_btActionPerformed
        DefaultTableModel tb1Model = (DefaultTableModel) TabelDataIbu_tab.getModel();
        if(TabelDataIbu_tab.getSelectedRowCount()==1){
            ...
            if(TabelDataIbu_tab.getRowCount()==0){
    ...
    private void fetchDataFromDatabase(String nik) {
        try {
            ...
            String query = "SELECT * FROM ibu WHERE nik = ?";
            ...
            if (rs.next()) {
                ...
                String umur_ibu = rs.getString("umur_ibu");
                java.util.Date tanggal_Lahir = rs.getDate("tanggal_Lahir");
                String UK = rs.getString("UK");
                ...
                dataIbuForm.setFields(nama, nik, umur_ibu, tanggal_Lahir, UK, alamat, status, ANC, RK);
                dataIbuForm.setVisible(true);
                getDesktopPane().add(dataIbuForm);
                dispose();
            }
            ...
            Logger.getLogger(TableIbuForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void showTable(String sql){
        try{
            ...
            tableModel = (DefaultTableModel)TabelDataIbu_tab.getModel();
    ...
    private void deleteDataFromDatabase(String nik){
        Connection conn = ConnectionDB.connectDatabase();
        String sql = "DELETE FROM ibu WHERE nik = ?";
    ...
    private javax.swing.JTable TabelDataIbu_tab;
